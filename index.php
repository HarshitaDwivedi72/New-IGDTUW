            ...
            <div class="bigBox">
                ...
                <ul class="ENABox Events active">
                    ...
                    <?php
                             getRecentEvents();
                    ?>
                    <a href="NEA.php?id=1" class="readmore"><i class="fa fa-hand-o-right"></i>&nbspRead More</a>
                </ul>
                <ul class="ENABox Notices">
                    ...
                    ?>
                        ...
                        <a href="NEA.php?id=2" class="readmore"><i class="fa fa-hand-o-right"></i>&nbspRead More</a>
                </ul>
                
                <ul class="ENABox Achievements">
                        <?php getDynamicAchievements();?>
                        <a href="NEA.php?id=3" class="readmore"><i class="fa fa-hand-o-right"></i>&nbspRead More</a>
                </ul>
