...
<body onload="main()">
            ...
            <div class="col-sm-3">
                <div class="sideNav">
                    ...
                    <ul class="sidenav">
                      ...
                      <li><a href="AboutUs.php?id=6" id="6">&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fa fa-chevron-circle-right">&nbsp&nbsp</i>University Court</a></li>
                      <li><a href="AboutUs.php?id=7" id="7">&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fa fa-chevron-circle-right">&nbsp&nbsp</i>Board of Management</a></li>
                      <li><a href="AboutUs.php?id=8" id="8">&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fa fa-chevron-circle-right">&nbsp&nbsp</i>Finance Committee</a></li>
                      <li><a href="AboutUs.php?id=9" id="9">&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fa fa-chevron-circle-right">&nbsp&nbsp</i>Academic Council</a></li>
                      <li><a href="AboutUs.php?id=10" id="10"><i class="fa fa-chevron-circle-right">&nbsp&nbsp</i>Administration</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-9">
  ...
  elseif($id==5 ) {
    ...
    <div class="middleBox">
        ...
        <div class="headingPara">
        <ul class="sidenav">
               <li><a href="AboutUs.php?id=6" target="_blank"><i class="fa fa-hand-o-right">&nbsp&nbsp&nbsp</i>University Court</a></li>
               <li><a href="AboutUs.php?id=7" target="_blank"><i class="fa fa-hand-o-right">&nbsp&nbsp&nbsp</i>Board of Management</a></li>
               <li><a href="AboutUs.php?id=8" target="_blank"><i class="fa fa-hand-o-right">&nbsp&nbsp&nbsp</i>Finance Commitee</a></li>
               <li><a href="AboutUs.php?id=9" target="_blank"><i class="fa fa-hand-o-right">&nbsp&nbsp&nbsp</i>Academic Council</a></li>
        </ul>
        </div>
    </div>';
  }
