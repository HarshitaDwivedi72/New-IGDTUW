...
<head>
    ...
    <link rel="stylesheet" class="stylesheet" href="stylesheet/style1.css">
    <link rel="stylesheet" class="stylesheet" href="stylesheet/vision.css">
    <style>
            ...
            <div class="col-sm-3">
                <div class="sideNav">
                    ...
                    <ul class="sidenav">
                        ...
                        <li><a href="">VC's Message</a></li>
                        <li><a href="">Founder VC's Message</a></li>
                        <li><a href="">Registrar's Message</a></li>
                        <li><a href="">Message-Dean(Examination Affairs)</a></li>
                        <li><a href="">Message-Dean(Academic Affairs)</a></li>
                        <li><a href="">Message-Dy. Dean(Industrial Research and Development)</a></li>
                        <li><a href="">Message-Dy. Dean(Students' Welfare)</a></li>
                        <li><a href="">Message-Dy. Dean(Research and Consultancy)</a></li>
